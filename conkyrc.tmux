...
TEXT
${if_match ${new_mails /home/darookee/.mail/darookee/INBOX/}>0} \#[fg=colour179,bg=colour240,nobold]\#[bg=colour179,fg=colour168]✉ \
\#[fg=colour238]${new_mails /home/darookee/.mail/darookee/INBOX/} \#[bg=colour179,fg=colour236]\#[bg=colour236] ${else} \#[bg=colour240,fg=colour236]\#[bg=colour236] ${endif}\
...
\#[fg=colour249]${execi 21600 /home/darookee/.bin.untracked/weathermajig -s Braunschweig} \#[fg=colour150,bg=colour237]\#[bg=colour150] \
