...
\#[fg=${if_match $cpu>25}red${else}green${endif}][$cpu%]\#[default]\#[fg=${if_match $memperc>75}red${else}magenta${endif}][${memperc}%]\#[default] \#[fg=grey]| \
...
\#[fg=green][\#[fg=cyan]${time %a, %Y-%m-%d (%V)}\#[fg=white] ${time %H:%M}\#[fg=green]]\#[default]\
